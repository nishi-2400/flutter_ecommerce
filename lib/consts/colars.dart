...
class ColorsContents {
  static Color black = Color(0xFF000000);
  static Color white = Color(0xFFFFFFFF);
  static Color title = Color(0xDD000000);
  static Color subtitle = Color(0x8A0000000);
  static Color backgroundColor = Color(0xFFE0E0E0);

  static Color favColor = Color(0xFF5E35B1);
  static Color favBudgeColor = Color(0xFFBA68C8);

  static Color gradiensFStart = Color(0xFFE040FB);
